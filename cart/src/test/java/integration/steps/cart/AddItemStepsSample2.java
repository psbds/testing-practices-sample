...
public class AddItemStepsSample2 {
    ...
    public void theProductIdExistsInTheProductCatalogWithMetadata(String productId, String stockQuantity, String price, String metadataKey, String metadataValues) {
    ...
    public void iAddProductToCartWithQuantityAndPriceAndMetadata(String productId, String quantity, String price, String metadataKey, String metadataValue) {
    ...
    public void theCartShouldContainProductWithQuantityAndPrice(String productId, String expectedQuantity, String expectedPrice) {
        ...
        assertFalse(items.isEmpty(), "Item should exist in the database for user " + userId + " and product " + productId);
        ...
        Log.info("Successfully validated item in database: productId=" + productId +
                ", quantity=" + expectedQuantity + ", price=" + expectedPrice + ", userId=" + userId);
    }
}
